...
// A variable is a name that can reference a specific value. Variables are declared
 // using var followed by the variable's name.

// Here's an example:

// var example;

// The above variable is declared, but it isn't defined (it does not yet reference
// a specific value).
...
// A variable is declared using var and uses the equals sign to define the value th
// at it references. This is colloquially known as "Making a variable equal a value
// ".

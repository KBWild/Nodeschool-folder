...
// Create a for loop with a variable i starting at 0 and increasing by 1 each time
// through the loop. The loop should run as long as i is less than limit.

// On each iteration of the loop, add the number i to the total variable. To do thi
// s, you can use this statement:

// total += i;

// After the for loop, use console.log() to print the total variable to the termina
// l.
...
{
	//Total number each iteration of var 'i'
	total+=i;
